        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirdh = table.Column<DateOnly>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Organizations_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationalMaterials_ContentTypes_ContentTypeId",
                        column: x => x.ContentTypeId,
                        principalTable: "ContentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EducationalMaterials_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PassedTests_Employees_EmployeeId",
            ...
            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "работает" });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "в отпуске" });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "Id", "Name" },
                values: new object[] { 3, "в командировке" });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "Id", "Name" },
                values: new object[] { 4, "уволен" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EducationalMaterials_ContentTypeId",
                table: "EducationalMaterials",
                column: "ContentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalMaterials_CourseId",
                table: "EducationalMaterials",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_ColorId",
                table: "Organizations",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_Organizations_TariffId",
                table: "Organizations",
                column: "TariffId");

            migrationBuilder.CreateIndex(
                name: "IX_PassedTests_EmployeeId",
                table: "PassedTests",
                column: "EmployeeId");
